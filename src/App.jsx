    ...
    <>
      ...
      <div className="container">
        <svg className="no-select poop-bg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96">
          <path fill="var(--acc1)" stroke="var(--main-white-bg)" strokeWidth="var(--poop-outline-width)" d="M82 64H14a8 8 0 0 0 0 16h68a8 8 0 0 0 0-16zm-60-4h52a8 8 0 0 0 0-16H22a8 8 0 0 0 0 16zm8-20h36a5.971 5.971 0 0 0 6-5.877c.027-5.873-1.848-11.145-5.145-14.457A12.238 12.238 0 0 0 58 16a1.999 1.999 0 0 0-2 2v2a8.01 8.01 0 0 1-8 8H30a6 6 0 0 0 0 12z" />
        </svg>
        ...
        <svg className="no-select poop-bg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96">
          <path fill="var(--acc2)" stroke="var(--main-white-bg)" strokeWidth="var(--poop-outline-width)" d="M82 64H14a8 8 0 0 0 0 16h68a8 8 0 0 0 0-16zm-60-4h52a8 8 0 0 0 0-16H22a8 8 0 0 0 0 16zm8-20h36a5.971 5.971 0 0 0 6-5.877c.027-5.873-1.848-11.145-5.145-14.457A12.238 12.238 0 0 0 58 16a1.999 1.999 0 0 0-2 2v2a8.01 8.01 0 0 1-8 8H30a6 6 0 0 0 0 12z" />
        </svg>
      </div>
    </>
  )
